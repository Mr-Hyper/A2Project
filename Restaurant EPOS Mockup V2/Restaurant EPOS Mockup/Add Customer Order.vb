Public Class Add_Customer_Order
    ...
    Private Sub BtnBack_Click(sender As Object, e As EventArgs) Handles BtnBack.Click
        ' Procedure takes you back to Customer Orders Menu when this button is clicked.
    ...
    Private Sub BtnAddItem_Click(sender As Object, e As EventArgs) Handles BtnAddItem.Click
        ...
        ' Procedure takes the specified quantity and selected Dish to then copy this information over to
        ' the Order Box.
    End Sub
    ...
    Private Sub BtnSelQuantity_Click(sender As Object, e As EventArgs) Handles BtnSelQuantity.Click
        ...
        ' This procedure loads the Window Form to select a Quantiy amount for a selected Dish.
    End Sub
